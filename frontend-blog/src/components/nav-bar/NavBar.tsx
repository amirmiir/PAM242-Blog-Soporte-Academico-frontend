        ...
        <header className="max-w-screen-2xl mx-auto px-4 border-b-2 border-gray-300 bg-gray-100 h-12">
            <nav className="flex justify-between items-center h-full">
                ...
                <div className="flex items-center space-x-6 font-semibold">
                    ...
                    <a href="#about" className="text-gray-600 hover:text-gray-800">Acerca de</a>

                    <a href="#us" className="text-gray-600 hover:text-gray-800">Nosotros</a>

                    <a href="#faq" className="text-gray-600 hover:text-gray-800">Preguntas Frecuentes</a>

                    <a href="#contact" className="text-gray-600 hover:text-gray-800">Contáctanos</a>
                </div>
